...
# - Added --measure_time command line argument to enable per-round timing
# - Removed matplotlib imports and data distribution visualization code
# =========================================================================
...
def get_args():
    ...
    parser.add_argument('--measure_time', action='store_true',
                        help='whether to measure and log the time per communication round')
